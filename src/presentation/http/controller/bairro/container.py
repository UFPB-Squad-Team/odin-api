...
from src.infrastructure.database.repository.mongo_bairro_repository import (
...
class BairroContainer(containers.DeclarativeContainer):
    repository = providers.Factory(
        ...
        bairro_collection=providers.Callable(
            mongodb.get_collection, "bairro_indicadores"
        ),
        setor_collection=providers.Callable(
            mongodb.get_collection, "setor_indicadores"
        ),
    )
